...
const App = () => {
  ...
  const copyPasswordToClipboard = useCallback(() => {
    passwordRef.current?.select(); // higlighting the copied password using ref hook

    window.navigator.clipboard.writeText(passwordAllowed); // window object can only  be used in password generatr
  }, [passwordAllowed]);
